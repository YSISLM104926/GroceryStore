              ...
              <div className="flex gap-12">
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="flex flex-wrap gap-4 mt-8">
                    <button type="button" className="min-w-[200px] transition-all duration-300 px-4 py-3 bg-green-300 hover:bg-green-400 text-black text-sm font-bold rounded">Buy now</button>
                    <button type="button" className="min-w-[200px] px-4 py-2.5 border border-green-300 bg-transparent text-green-300 text-sm font-bold rounded">Add to cart</button>
                  </div>
                  <div className="mt-8">
